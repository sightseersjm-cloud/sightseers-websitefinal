        ...
        await sendEmail({
          ...
          html: `
            ...
            <table style="border-collapse:collapse;width:100%;font-family:sans-serif">
              ...
              <tr><td style="padding:8px;font-weight:bold">Account Type</td><td style="padding:8px;text-transform:capitalize">${escapeHtml(entry.type)}</td></tr>
              ${entry.location ? `<tr style="background:#f5f5f5"><td style="padding:8px;font-weight:bold">Location</td><td style="padding:8px">${escapeHtml(entry.location)}</td></tr>` : ''}
              ${entry.experience != null ? `<tr><td style="padding:8px;font-weight:bold">Experience</td><td style="padding:8px">${escapeHtml(entry.experience)} years</td></tr>` : ''}
              ${entry.interests && entry.interests.length ? `<tr style="background:#f5f5f5"><td style="padding:8px;font-weight:bold">Interests</td><td style="padding:8px">${entry.interests.map(escapeHtml).join(', ')}</td></tr>` : ''}
              ${entry.bio ? `<tr><td style="padding:8px;font-weight:bold;vertical-align:top">Bio</td><td style="padding:8px">${escapeHtml(entry.bio)}</td></tr>` : ''}
